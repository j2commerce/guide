...
* Main Tag - The tag selected here will be used for canonical url. More details about canonical url could be found here [click here](https://docs.j2store.org/catalog/\[http://docs.j2store.org/canonical-url-plugin]\(%3Chttp:/docs.j2store.org/canonical-url-plugin%3E\))
...
Also, you can add some other products to convince the customer to buy these products additionally. This is cross-sell.
