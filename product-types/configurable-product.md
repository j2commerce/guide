...
![Choosing the product type](<../.gitbook/assets/config-create-new (1).webp>)
...
![Setting option values](../.gitbook/assets/config-options-new.webp)
...
![Defining option values](../.gitbook/assets/config-options-value-new.webp)
...
![Filters for configurable products](../.gitbook/assets/config-filter-new.webp)
...
![Relations in a configurable product](../.gitbook/assets/config-relations-new.webp)
